...
export default function AboutPage() {
  ...
  const achievements = [
    ...
    { value: "180+", label: "сотрудников" },
    { value: "2M+", label: "абонентов в системах" },
  ]

  const certifications = [
    "Сертифицированное российское ПО",
    "Сертификат ГОСТ Р ИСО 9001-2015 (ISO 9001:2015)",
    "Сертификат ГОСТ Р ИСО/МЭК 27001-2021 (ISO/IEC 27001:2013)",
    ...
    <div className="flex flex-col">
      ...
      <section className="border-b border-border bg-muted/30 py-16 md:py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl">
            <div className="mb-8 flex items-center gap-4">
              <Building2 className="h-8 w-8 text-primary" style={{ color: "rgb(190, 18, 18)" }} />
              <h2 className="text-3xl font-bold">Сведения о компании</h2>
            </div>
