...
export default function CasesPage() {
  const cases = [
    ...
    {
      client: "Сансим",
      title: "Интеграции с Ростелеком",
      description: "Построение интеграционных решений с оператором Ростелеком",
      solution: "Обмен данными, маршрутизация трафика, взаиморасчёты",
      result: "Расширение географии услуг, дополнительная номерная ёмкость",
      tags: ["Ростелеком", "Интеграция", "Телеком"],
    },
    {
      client: "Различные заказчики",
      title: "ВАТС-проекты",
      ...
      tags: ["ВАТС", "Телефония", "CRM"],
    },
    {
      client: "Различные заказчики",
      title: "Виджет обратной связи",
      description: "Решение для инициации звонков с веб-сайтов",
      solution: "Callback-виджет с интеграцией в ВАТС и CRM",
      result: "Увеличение конверсии лидов, быстрая связь с клиентами",
      tags: ["Callback", "Web", "Лиды"],
    },
    {
      client: "Различные заказчики",
      title: "Коллтрекинг",
      description: "Системы отслеживания эффективности рекламных кампаний",
      solution: "Динамическая подстановка номеров, аналитика источников звонков",
      result: "Оптимизация рекламных бюджетов, ROI маркетинговых каналов",
      tags: ["Коллтрекинг", "Маркетинг", "Аналитика"],
    },
    {
      client: "Текущие проекты",
      title: "Онлайн-магазины",
      description: "E-commerce платформы для продажи телеком-услуг",
      solution: "Интернет-витрины, корзина, оплата, интеграция с биллингом",
      result: "В стадии разработки и тестирования",
      tags: ["E-commerce", "Онлайн", "Продажи"],
    },
    {
      client: "Текущие проекты",
      title: "Мобильные приложения",
      description: "Нативные приложения для iOS и Android",
      solution: "Личный кабинет в мобильном формате, push-уведомления",
    ...
    },
    {
      ...
      title: "Full-MVNO",
      description: "Полноценный виртуальный оператор для партнёров",
