...
export const metadata: Metadata = {
  title: "Решения на основе искусственного интеллекта (AI) и речевая аналитика — ООО «ФТС»",
  description:
    "Речевая аналитика на базе искусственного интеллекта (AI) для контакт-центров. Распознавание речи, анализ эмоций, контроль качества, автоматическая оценка операторов",
}
