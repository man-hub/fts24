...
import { Voicemail, Mail, Download, ArrowRight, Check } from "lucide-react"
import Link from "next/link"

export const metadata: Metadata = {
  title: "Голосовая почта — Виртуальная АТС | ООО «ФТС»",
  description:
    "Голосовая почта для бизнеса: прием сообщений от клиентов 24/7, уведомления на email, хранение и прослушивание через личный кабинет",
}
...
export default function VoiceMailPage() {
  const features = [
    {
      icon: Voicemail,
      title: "Запись сообщений",
      description: "Клиенты оставляют голосовые сообщения, когда все операторы заняты или вне рабочего времени",
    },
    {
      icon: Mail,
      title: "Уведомления на email",
      description: "Получайте мгновенные уведомления о новых сообщениях с аудиофайлом во вложении",
    },
    {
      icon: Download,
      title: "Хранение и выгрузка",
      description: "Все сообщения хранятся в личном кабинете с возможностью скачивания и прослушивания",
    },
  ]

  const benefits = [
    "Не теряйте клиентов вне рабочего времени",
    "Автоматические уведомления на почту",
    "Персонализированные приветствия",
    "Гибкие настройки переадресации",
    "Интеграция с CRM-системами",
    "Неограниченное хранение сообщений",
  ]

  const relatedFeatures = [
    {
      title: "IVR (Голосовое меню)",
      url: "/vats/ivr",
    ...
    },
    {
      ...
      description: "Сохранение всех диалогов с клиентами",
    },
  ]
      ...
      <div className="border-b border-border bg-muted/30 py-3">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <span>/</span>
            <span className="text-foreground">Голосовая почта</span>
          </div>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <h1 className="mb-6 text-4xl font-bold tracking-tight md:text-5xl lg:text-6xl text-balance">
              Голосовая почта для бизнеса
            </h1>
            <p className="mb-8 text-lg text-muted-foreground md:text-xl text-pretty">
              Принимайте голосовые сообщения от клиентов круглосуточно. Автоматические уведомления и удобное хранение в
              личном кабинете
            </p>
      ...
      <section className="border-b border-border py-16 md:py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-12 text-center">
            <h2 className="mb-4 text-3xl font-bold md:text-4xl">Возможности голосовой почты</h2>
            <p className="mx-auto max-w-2xl text-lg text-muted-foreground">
              Все необходимое для работы с голосовыми сообщениями
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl">
            <div className="mb-12 text-center">
              ...
              <p className="text-lg text-muted-foreground">Почему голосовая почта важна для вашей компании</p>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-4xl">
            ...
            <div className="grid gap-6 md:grid-cols-4">
              {[
                { step: "1", text: "Клиент звонит, но все операторы заняты" },
                { step: "2", text: "Система предлагает оставить голосовое сообщение" },
                { step: "3", text: "Вы получаете уведомление на email" },
                { step: "4", text: "Прослушиваете и обрабатываете обращение" },
              ].map((item, index) => (
      ...
      <section className="bg-primary py-16 text-primary-foreground md:py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="mb-6 text-3xl font-bold md:text-4xl text-balance">Подключите голосовую почту сегодня</h2>
            <p className="mb-8 text-lg opacity-90 text-pretty">
              Не теряйте ни одного обращения клиентов даже вне рабочего времени
            </p>
