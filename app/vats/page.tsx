...
export default function VATSPage() {
  ...
  const useCases = [
    ...
    },
    {
      ...
      description: "Управление звонками клиентов, интеграция с CRM-системами (системами управления взаимоотношениями с клиентами), контроль качества",
      icon: Users,
    },
    {
    ...
    {
      title: "Крупный бизнес (Enterprise)",
